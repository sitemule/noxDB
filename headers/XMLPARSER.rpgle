...
I       Dcl-PR xml_Clear  extproc(*CWIDEN : 'jx_Clear');
...
I       Dcl-PR xml_MemUse Uns(20) extproc(*CWIDEN : 'jx_MemUse');
        End-PR;
...
I       Dcl-PR xml_httpRequest Pointer extproc(*CWIDEN:'jx_httpRequest');
