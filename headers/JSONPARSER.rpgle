      ...
      /endif
        ...
        Dcl-PR  json_setDelimitersByCcsid   
        ...
        Dcl-PR json_SetTimeStamp Pointer 
        ...
        Dcl-PR  json_DataGen  Pointer(*Proc)  extproc(*CWIDEN : 'jx_dataGen');
          pNode          Pointer   ; // Note this is parse by reference Pointer to json_ tree
        End-PR;
      ...
      //  .object.array[123].name
        ...
        Dcl-PR json_GetTimeStamp TimeStamp  
        ...
        // Synoným/shorthand for json_NodeDelete
      ...
      // Execute an update table where the row is defined as a json object
        ...
        Dcl-PR json_sqlGetInsertId Int(20) 
