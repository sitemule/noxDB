**FREE
      ...
      /endif
        ...
        //
        // @param Node
        // @param Format option (NOX_FORMAT_DEFAULT, XML_FORMAT_CDATA)
        // @return Passed node (first parameter)
        ///
        Dcl-PR xml_setNodeOptions pointer extproc(*CWIDEN : 'nox_SetNodeOptions');
          node pointer value;
          format int(5) value;
        End-PR;
        ...
        // @return New node
        ///
        Dcl-PR xml_SetNull pointer extproc(*CWIDEN : 'nox_SetNullByNameVC');
          node pointer value;
        ...
        Dcl-PR xml_GetValueStr Like(UTF8) rtnparm
        ...
        Dcl-PR xml_GetName Like(UTF8)  rtnparm
                          extproc(*CWIDEN : 'nox_GetNodeNameVC');
          // Pointer to node
          pNode          Pointer    value;
        End-PR;

        Dcl-PR xml_GetNameAsPath Like(UTF8) rtnparm
      ...
      // NL-OK 
        ...
        Dcl-PR xml_NodeInsert Pointer extproc(*CWIDEN : 'nox_NodeInsertVC');
      ...
      // Array functions
        ...
        //       call.
        ///
        Dcl-PR xml_documentInsert pointer extproc(*CWIDEN : 'nox_documentInsert');
        ...
        ///
        Dcl-C XML_STREAM_JSON const(0);
        Dcl-C XML_STREAM_XML  const(1);
        Dcl-C XML_STREAM_CSV  const(2);
