...
I       Dcl-PR jx_Clear  extproc(*CWIDEN : 'jx_Clear');
...
I       Dcl-PR jx_MemUse Uns(20) extproc(*CWIDEN : 'jx_MemUse');
        End-PR;
...
I       Dcl-PR jx_httpRequest Pointer extproc(*CWIDEN:'jx_httpRequest');
