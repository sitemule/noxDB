...
///
Dcl-PR jx_getDelimiters Pointer extproc(*CWIDEN : 'jx_GetDelimiters') End-PR;

///
// Set delimiters
//
// Sets the delimiters used for parsing the JSON and XML data.
// For the default delimiters see constant JX_DELIMITERS.
//
// @param Delimiters
///
...
Dcl-S JX_UTF8 varchar(1048572) CCSID(*UTF8) Template;
///
...
///
Dcl-PR jx_getMessageObject pointer extproc(*CWIDEN : 'jx_GetMessageObject');
...
///
Dcl-PR jx_locateOrCreate pointer extproc(*CWIDEN : 'jx_GetOrCreateNode');
  node pointer value;
  nodePath pointer value options(*string);
End-PR;
...
// @return Changed node
///
Dcl-PR jx_setStrUtf8 Pointer extproc(*CWIDEN : 'jx_SetStrUtf8ByName');
  pNode          Pointer    value;
  Expression     Like( JX_UTF8 ) const options(*nopass:*varsize);
  Defaultvalue   Like( JX_UTF8 ) const options(*nopass:*varsize);
  nullIf         ind value options(*nopass);
End-PR;
...
Dcl-PR jx_Int pointer extproc(*CWIDEN : 'jx_Int');
  value int(20) value;
End-PR;
...
// @param Node type (see node type constants, default JX_UNKNOWN)
// @return Changed node
///
...
//         does not exist
///
Dcl-PR jx_getValueStr varchar(32767) extproc(*CWIDEN : 'jx_GetNodeValueVC');
  node pointer value;
...
///
Dcl-PR jx_getValueNum packed(30:15) extproc(*CWIDEN : 'jx_GetNodeValueNum');
  node pointer value;
...
// @return Node name
///
Dcl-PR jx_getName varchar(32767) extproc(*CWIDEN : 'jx_GetNodeNameVC');
  node pointer value;
End-PR;
...
///
Dcl-PR jx_getStrUtf8 Like( JX_UTF8 ) rtnparm extproc(*CWIDEN : 'jx_GetStrUtf8ByName');
  pNode          Pointer    value;
  Expression     Like( JX_UTF8 ) const options(*nopass:*varsize);
  Defaultvalue   Like( JX_UTF8 ) const options(*nopass:*varsize);
End-PR;
...
///
Dcl-PR jx_getTimeStamp timestamp extproc(*CWIDEN : 'jx_GetValueTimeStamp');
  node pointer value;
  nodePath pointer value options(*string : *nopass);
...
// <br><br>
// If the source node is an object or array (type JX_ARRAY or JX_OBJECT) the
...
///
Dcl-PR jx_moveValue pointer extproc(*CWIDEN : 'jx_MoveValue');
  destNode pointer value;
  destName pointer value options(*string);
  sourceNode pointer value;
  sourceName pointer value options(*string);
...
End-PR;
Dcl-PR jx_Obj pointer extproc(*CWIDEN : 'jx_Object');
...
Dcl-PR jx_newArray pointer extproc(*CWIDEN : 'jx_NewArray');
  node pointer value options(*nopass);
End-PR;
Dcl-PR jx_Arr pointer extproc(*CWIDEN : 'jx_Array');
  p00 pointer value options(*nopass:*string);
  p01 pointer value options(*nopass:*string);
  p02 pointer value options(*nopass:*string);
  p03 pointer value options(*nopass:*string);
...
// @param Push operation mode (JX_MOVE_UNLINK (default) or JX_COPY_CLONE)
...
// @param Copy operation mode. JX_MOVE_UNLINK (default) removes the "sliced"
//        nodes from the source array. JX_COPY_CLONE leaves the nodes in
...
// @param Compare options (0 = use JSON numeric (default) or JX_USE_LOCALE)
// @return Sorted array
///
...
// @param Copy operation mode. JX_MOVE_UNLINK (default) removes the "input array of object"
//        node. JX_COPY_CLONE leaves the node
// @return New array with the "converted" nodes
///
Dcl-PR jx_arrayConvertList pointer extproc(*CWIDEN : 'jx_ArrayConvertList' );
  array pointer value options(*string);
  copyMode uns(5) value options(*nopass);
End-PR;
...
// @param Search value
// @param Case sensitivity (JX_SAME_CASE or JX_IGNORE_CASE)
...
//       call.
///
Dcl-PR jx_documentInsert pointer extproc(*CWIDEN : 'jx_documentInsert');
  destination pointer value;
  source pointer;
...
// @return Object tree representation as a JSON string
///
Dcl-PR jx_AsJsonText16M Like(VARCHAR16M)  rtnparm
...
///
Dcl-PR jx_strQuote  varchar(32767)  rtnparm
...
// see jx_forEach. Thus multiple iterators can be used on the same object
...
///
Dcl-PR jx_getAttrValue varchar(32767) extproc(*CWIDEN : 'jx_GetAttrValueVC');
...
Dcl-PR jx_CallProgram pointer extproc(*CWIDEN : 'jx_CallProgram');
...
Dcl-PR jx_ProgramMeta pointer extproc(*CWIDEN : 'jx_ProgramMeta');
  library        char(10) const;
  program        char(10) const;
  formatOptions  int(10) value options(*nopass) ;
End-PR;
...
Dcl-PR jx_CallProcedure pointer extproc(*CWIDEN : 'jx_CallProcedure');
  library        char(10)    const;
...
Dcl-PR jx_ProcedureMeta pointer extproc(*CWIDEN : 'jx_ProcedureMeta');
  library        char(10)  const;
  program        char(10)  const;
  procedure      pointer   value options(*string);
  formatOptions  int(10)   value options(*nopass) ;
...
Dcl-PR jx_ApplicationMeta pointer extproc(*CWIDEN : 'jx_ApplicationMeta');
  library        char(10)  const;
  program        char(10)  const;
  procedure      pointer   value options(*string);
End-PR;
...
//         <code>*off</code>
///
Dcl-PR jx_memLeak ind extproc(*CWIDEN : 'jx_MemLeak') End-PR;
...
///
Dcl-PR jx_memStat extproc(*CWIDEN : 'jx_MemStat') End-PR;
...
///
Dcl-PR jx_memUse uns(20) extproc(*CWIDEN : 'jx_MemUse') End-PR;
...
// SQL interface
//
// Note: When SQL functions return *NULL, then use  the jx_Message() to
...
///
Dcl-PR jx_sqlSetRootName extproc(*CWIDEN : 'jx_sqlSetRootName');
...
///
Dcl-PR jx_sqlValues pointer extproc(*CWIDEN: 'jx_sqlValues');
  statement pointer value options(*string);
  templateValues pointer value options(*string : *nopass);
  formatOptions int(10) value options(*nopass);
End-PR;
...
// @param Max. number of rows (default: JX_ALLROWS)
// @param Result set format options
// @param Template values (context)
// @return Result set
///
...
// faster than JX_TOTALROWS but is not as precise.
///
...
///
Dcl-C JX_GRACEFUL_ERROR   const(128);
...
///
Dcl-PR jx_sqlFetchRelative pointer extproc(*CWIDEN: 'jx_sqlFetchRelative');
...
//       of the returned noxDB object tree by calling <em>jx_delete(node)</em>.
///
Dcl-PR jx_sqlCall pointer extproc(*CWIDEN : 'jx_sqlCall');
...
//       of the returned noxDB object tree by calling <em>jx_delete(node)</em>.
///
Dcl-PR jx_sqlExecuteRoutine pointer extproc(*CWIDEN : 'jx_sqlExecuteRoutine');
...
//       of the returned noxDB object tree by calling <em>jx_delete(node)</em>.
///
Dcl-PR jx_sqlCallNode ind extproc(*CWIDEN : 'jx_sqlCallNode');
  procedureName pointer value options(*string);
...
//         executed
///
Dcl-PR jx_sqlGetInsertId int(20) extproc(*CWIDEN : 'jx_sqlGetInsertId2');
End-PR;
...
///
Dcl-PR jx_sqlStartTransaction ind extproc(*CWIDEN : 'jx_sqlStartTransaction');
End-PR;
...
// @return <code>*on</code> if an error occured else <code>*off</code>
///
Dcl-PR jx_sqlCommit ind extproc(*CWIDEN : 'jx_sqlCommit') End-PR;
...
// @return <code>*on</code> if an error occured else <code>*off</code>
///
Dcl-PR jx_sqlRollback ind extproc(*CWIDEN : 'jx_sqlRollback') End-PR;
...
///
Dcl-PR jx_sqlCode int(10) extproc(*CWIDEN : 'jx_sqlCode') End-PR;
