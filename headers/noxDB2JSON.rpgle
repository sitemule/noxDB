**FREE
      ...
      /endif
        ...
        //
        // @param Node
        // @param Format option (NOX_FORMAT_DEFAULT, JSON_FORMAT_CDATA)
        // @return Passed node (first parameter)
        ///
        Dcl-PR json_setNodeOptions pointer extproc(*CWIDEN : 'nox_SetNodeOptions');
          node pointer value;
          format int(5) value;
        End-PR;
        ...
        Dcl-PR json_GetValueStr Like(UTF8) rtnparm
      ...
      // NL-OK 
        ...
        Dcl-PR json_NodeInsert Pointer extproc(*CWIDEN : 'nox_NodeInsertVC');
      ...
      // Array functions
        ...
        //       call.
        ///
        Dcl-PR json_documentInsert pointer extproc(*CWIDEN : 'nox_documentInsert');
        ...
        Dcl-PR json_StreamJson pointer extproc(*CWIDEN : 'nox_StreamJson');
          // node. Retrive from Locate()
          pNode          Pointer    value;
        End-PR;

        // Return a streamer object to be used in own serialisers 
        Dcl-PR json_StreamXml pointer extproc(*CWIDEN : 'nox_StreamXml');
          // node. Retrive from Locate()
          pNode          Pointer    value;
        End-PR;
