...
/include qrpgleRef,noxdb
   ...
   // Set the delimiters used to access the graph
...
dcl-proc example1;
   ...
   json_WriteJsonStmf(p1:'/prj/noxdb/testout/json-merge1.json':1208:*ON);
   json_delete(p1   );
   json_delete(p2   );
   ...
   json_dump(pRcv );
   json_WriteJsonStmf(pR:'/prj/noxdb/testout/json_out.json':1208:*OFF);
   json_delete(pJson);
   json_delete(pRcv );
...
dcl-proc example2;
   ...
   Dcl-S pFrom       pointer;
   Dcl-S pTo         pointer;
   Dcl-S Content1    varchar(256);
   Dcl-S Content2    varchar(256);
   dcl-s memleak	   ind;
   ...
   Content1 = json_AsJsonText(pFrom);
