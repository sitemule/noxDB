      ...
      /include qrpgleRef,noxdb
       ...
       Dcl-S n                   Packed(15:2);
          *inlr = *on;
          ...
          json_WriteJsonStmf (pJson1:'/prj/noxdb/testout/json_out1.json':1208:*OFF);
          json_WriteJsonStmf (pJson2:'/prj/noxdb/testout/json_out2.json':1208:*OFF);

          json_merge (pJson1 : pJson2 : json_DONTREPLACE);
          json_WriteJsonStmf (pJson1:'/prj/noxdb/testout/json_merge.json':1208:*OFF);
          json_delete(pJson1);
          json_delete(pJson2);
